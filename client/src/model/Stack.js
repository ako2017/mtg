class Stack extends Observable {
	constructor() {
		super();
		this.stack = [];
		this.onlyOneTypeInStack = [TypeCard.ARTEFACT,TypeCard.CREATURE,TypeCard.ENCHANTEMENT,TypeCard.PLANES_WALKER,TypeCard.RITUEL];
	}
	...
	canPlayCardOfType(type) {
		if(TypeCard.EPHEMERE == type || TypeCard.CAPACITY == type) {
			return true;
		}
		else if(this.stack.length >0) {
			return !this.onlyOneTypeInStack.contains(this.stack[0].type);
		}
		return true;
	}
